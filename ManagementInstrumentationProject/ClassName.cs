...
namespace ManagementInstrumentationProject
{
    public class ClassName
    {
        ...
        public List<string> getAllClassNameToList()
        {
            List<string> returnedList = new List<string>();
            foreach (string item in Enum.GetNames(typeof(Names)))
                returnedList.Add(item);
            return returnedList;
        }

        public string[] getAllClassNameToArray()
        {
            return getAllClassNameToList().ToArray();
        }
